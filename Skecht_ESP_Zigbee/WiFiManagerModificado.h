...
#ifndef WiFiManagerModificado_h
#define WiFiManagerModificado_h
...
class WiFiManagerModificadoParameter {
  public:
    /** 
        Create custom parameters that can be added to the WiFiManagerModificado setup web page
        @id is used for HTTP queries and must not contain spaces nor other special characters
    */
    WiFiManagerModificadoParameter();
    WiFiManagerModificadoParameter(const char *custom);
    WiFiManagerModificadoParameter(const char *id, const char *label);
    WiFiManagerModificadoParameter(const char *id, const char *label, const char *defaultValue, int length);
    WiFiManagerModificadoParameter(const char *id, const char *label, const char *defaultValue, int length, const char *custom);
    WiFiManagerModificadoParameter(const char *id, const char *label, const char *defaultValue, int length, const char *custom, int labelPlacement);
    ~WiFiManagerModificadoParameter();
    // WiFiManagerModificadoParameter& operator=(const WiFiManagerModificadoParameter& rhs);
  ...
  private:
    WiFiManagerModificadoParameter& operator=(const WiFiManagerModificadoParameter&);
    const char *_id;
    const char *_label;
    char       *_value;
    int         _length;
    ...
    friend class WiFiManagerModificado;
};


class WiFiManagerModificado
{
  public:
    WiFiManagerModificado(Stream& consolePort);
    WiFiManagerModificado();
    ~WiFiManagerModificado();
    void WiFiManagerModificadoInit();
    ...
    bool          addParameter(WiFiManagerModificadoParameter *p);

    //returns the list of Parameters
    WiFiManagerModificadoParameter** getParameters();
    ...
    void          setAPCallback( std::function<void(WiFiManagerModificado*)> func );
  ...
  private:
    ...
    int         _paramsCount          = 0;
    int         _max_params;
    WiFiManagerModificadoParameter** _params    = NULL;
    ...
    #ifdef WM_DEBUG_PORT
    Stream& _debugPort = Serial1;
    #else
    Stream& _debugPort = Serial1; // debug output stream ref
    #endif
    ...
    std::function<void(WiFiManagerModificado*)> _apcallback;
